...
- **[BMad Auto-Run Implementation Plan](./bmad-auto-run-plan.md):** The task-by-task plan the design above was built from, and the record of where it was corrected under review. Read it with the design record, not instead of it.
