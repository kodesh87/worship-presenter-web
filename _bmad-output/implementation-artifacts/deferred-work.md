...
- source_spec: `_bmad-output/implementation-artifacts/stories/17-1-reachable-dark-mode.md`
  owner: unassigned — belongs with whichever story next opens `tests/theme-chrome.test.mjs`; Story 17.7 is the likely one, since AD-24 names that suite as its closure gate and 17.7 has to rewrite the assertion set anyway
