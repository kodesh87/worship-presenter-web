...
| M+2   | `break-time`          | `text`       | **BreakTime**         | General         | —                   | Canvas: "Break Time", "5 MINUTES", "Bank Mandiri 12345 67 8901 23 Gereja Masehi Advent Hari Ketujuh BIC". Fixed.                                                                     |
...
| 3   | `offering-tithe`       | `body`       | **OfferingTithe**       | General        | —                                                      | Canvas: "Offering & Tithe", "1234567890123 Gereja Masehi Advent Hari Ketujuh BIC", "Bank Mandiri".                                  |
...
| 6   | `contact`              | `body`       | **Contact**             | General        | —                                                      | Canvas: "For more information", "example.org/contact". Fixed.                                                                               |
